...
class PlayerCap(db.Model):
    __bind_key__ = 'contracts'
    __table__ = CapBase.metadata.tables["PlayerCap"]
...
class Contract(db.Model):
    __bind_key__ = 'contracts'
    __table__ = CapBase.metadata.tables["ContractDetail"]
...
class Team(db.Model):
    __bind_key__ = 'contracts'
    __table__ = CapBase.metadata.tables["Team"]
